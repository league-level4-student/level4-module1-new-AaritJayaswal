...
public class PolymorphismDemo {
	public static void main(String[] args) {
		 ...
		 * 
		 * 1. Change the code below so that animal is set equal to a new Dog, Bird or
		 * Fish on the right side of the equals sign while still being declared as an
		 * Animal on the left side.
		 */
		 ...
		 * 
		 * Even though the variable was declared as an Animal, at run time it will
		 * behave like whatever Animal subclass it was instantiated as.
		 */
		animal.speak();
		/*
		 * 3. Comment out the speak method of the Animal subclass you chose and run the
		 * program again.
		 * 
		 * This time since there was no speak method in the Animal subclass you chose,
		 * the next closest speak method in the class's inheritance was called. In this
		 * case it was Animal class's version of speak.
		 */

		/*
		 * 4. Add another method called eat to the Animal subclass you chose and have it
		 ...
		 * 
		 * If the eat method was instead in the Animal class it would work as expected.
		 * 
		 * You can also cast the Animal into the Animal subclass you chose before
		 * calling the method.
		 * 
